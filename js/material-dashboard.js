...
$(document).ready(function() {
    ...
    0 != $(".tagsinput").length && $(".tagsinput").tagsinput(), $(".bootstrap-tagsinput").addClass(e + "-badge"), $(".select").dropdown({
        ...
        a.find(".fix-broken-card").click(function() {
            ...
            var e = $(this);
            hover_count = parseInt(e.attr("data-count"), 10) + 1 || 0, e.attr("data-count", hover_count), 30 <= hover_count && $(this).children(".card-header, .card-header-image").addClass("hinge animated")
        })
    ...
    initDashboardPageCharts: function() {
        if (0 != $("#dailySalesChart").length || 0 != $("#completedTasksChart").length || 0 != $("#websiteViewsChart").length) {
            ...
            var a = Chartist.Bar("#websiteViewsChart", {
                labels: ["J", "F"],
                series: [
                    [542, 443],
                    [542, 43],
            ...
            var b = Chartist.Bar("#dailySalesChart", {
                labels: ["J", "F"],
                series: [
                    [542, 443],
                    [542, 43],
            ...
            var c = Chartist.Bar("#completedTasksChart", {
                labels: ["J", "F"],
                series: [
                    [542, 443],
                    [542, 43],
            ...
            md.startAnimationForBarChart(b)
            md.startAnimationForBarChart(c)
        }
    },
